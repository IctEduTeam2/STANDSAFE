	...
	<div id="mydiv">
		...
		<section id="contents">
			<article>
					...
					<button class="btn" onclick="return5()">관리목록</button>		
					</div>
					<hr class="hr">
					<!-- 메인 테이블 -->
					<table class="m_table">				
						...
						<tbody class="mb_table">		
							<tr>
								<td>1</td><td>없음</td><td><a href="/ad_report_onelist_user.do">솜털애기 신고합니다</a></td><td>***</td><td>22.01.10</td>
							</tr>	
							<tr>
								<td>2</td><td>있음</td><td><a href="/ad_report_onelist.do">[RE] 관리자 답글입니다. </a></td><td>관리자</td><td>23.02.10</td>
							</tr>	
