...
<script type="text/javascript">
	...
	function bbs_go_adreport_update(f) {
		location.href="/bbs_adreport_update.do";
...
<body onload="InitializeStaticMenu();">
	<div id="mydiv">
		...
		<section id="contents">
			<article>
					<hr class="hr">
					<div id="bbs_sub"><h1>신고게시글 답글 상세화면</h1></div>
						...
						<table class="m_table">
							...
							<tr align="center">
								...
								<td colspan="2" style="height: 800px;">
									네, 솜털애기에게 경고와 징계를 주겠습니다. 신고 감사합니다. 
								</td>
							</tr>
							</tbody>
							<tfoot>
								<tr align="center">
									<td colspan="2">
										<input type="button" value="수정" onclick="bbs_go_adreport_update(this.form)" class="in_btn"/>
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
