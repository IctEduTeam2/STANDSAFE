...
<script type="text/javascript">
	...
	function bbs_go_adfaq_writeform() {
		location.href="/ad_faqform.do";
		
	}
	function return2() {
		location.href="/return2.do";
	...
	<div id="mydiv">
		...
		<section id="contents">
			<article>
					...
					<div>
					<button class="btn" onclick="bbs_go_adfaq_writeform()">글쓰기</button>		
					<button class="btn" onclick="return2()">관리목록</button>		
					</div>	
					<hr class="hr">
					<!-- 메인 테이블 -->
					<table class="m_table">				
