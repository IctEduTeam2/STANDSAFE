...
<jsp:include page="header.jsp"></jsp:include>
	...
	<div class="admin_content_wrap" style="margin: auto; width: 100%;">
		<div style="width: 80%; margin: auto;">
			<div style="width: 98%; background-color: #1b5ac2; color: white;  margin: 30px 0;  padding-left: 2%; padding-top: 50px; padding-bottom: 50px; float: left; font-size: 32px;">반품 목록</div>
		</div>
				...
				<table class="order_table">
					...
					<tbody>
						<tr>
							...
							<td><a href="/return_detail.do">20230828k</a></td>
							<td>사용자1</td>
							<td>2023-01-01</td>
							<td>2023-01-01</td>
							<td>상품 준비중</td>
