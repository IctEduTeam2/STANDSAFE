...
<jsp:include page="header.jsp"></jsp:include>
		...
		<h1 style="text-align: center; font-size: 18px;">전체 공지사항 게시글 : 125개</h1></p>
		<br>
		<h1 style="text-align: center; font-size: 18px;">등록한 공지사항 게시글 : 125개</h1></p>
		<br>
	...
	<thead>
		...
		<div>
			<span style="float: right; margin-top: 25px; margin-right: 170px;">
				...
				style="width: 150px; height: 50px; font-size: 16px; border-radius: 10px; background-color: #505BBD; color: white; border: none;" onclick="location.href='/ad_allnotice.do'">공지사항❐</button>
			</span> <span style="float: right; margin-top: 25px; margin-right: 50px;">
				<button type="button" alt="글쓰기" value="글쓰기"
				style="width: 150px; height: 50px; font-size: 16px; border-radius: 10px; background-color: #505BBD; color: white; border: none;"onclick="location.href='/ad_noticeform.do'">글쓰기</button>
			</span> <span style="float: right; margin-top: 25px; margin-right: 50px;">
