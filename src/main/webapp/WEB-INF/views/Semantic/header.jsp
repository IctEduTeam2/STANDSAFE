...
<body>
	<header id="header">
		<div id="top_gnb">
			...
			<!-- 로그인 된 상태 -->
			<div id="loggedIn">
				<a class="top_gnb_a">${nick }님(P:${POINT_REM })</a> <a
					class="top_gnb_a" href="/logoutGo.do">로그아웃</a> <a class="top_gnb_a"
					href="/orderlistform.do?client_num=${id}">주문조회</a> <a
					class="top_gnb_a" href="/basketform.do?client_num=${id}">장바구니</a> <a
					class="top_gnb_a" href="/mypageform.do?client_num=${id }">마이페이지</a>
				<a href="/wishlistform.do?client_num=${id }" class="top_gnb_last_a">관심상품</a>
			</div>
			<%
			} else {
			%>
			<div id="loggedOut">
				<a class="top_gnb_a" href="/loginform.do">로그인</a> <a
					class="top_gnb_last_a" href="/registerform.do">회원가입</a>
			</div>
			<%
			}
			%>
			...
			<ul class="menu">
				...
				<li><a href="/productsform.do?prod_high=2&prod_low=1&sort=1">재난/응급/긴급</a>
					<ul class="submenu">
						...
						<li><a href="/productsform.do?prod_high=2&prod_low=2&sort=1">재난
								안전용품</a></li>
						<li><a href="/productsform.do?prod_high=2&prod_low=3&sort=1">방역
								안점용품</a></li>
					</ul></li>
