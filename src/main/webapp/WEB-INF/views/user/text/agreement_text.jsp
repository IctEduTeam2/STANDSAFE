...
<body>
개인 회원 약관 (개정 및 적용 2023. 04. 14)
제1장 총칙
제1조 (목적)
본 약관은 ㈜STANDSAFE(이하 "회사"라 합니다)이 운영하는 웹사이트(이하 “사이트”라 합니다) 및 모바일 애플리케이션(이하 “애플리케이션”이라 하며, 사이트와 애플리케이션을 총칭하여 “사이트 등”이라 합니다)을 통해 서비스를 제공함에 있어 회사와 이용자의 이용조건 및 제반 절차, 기타 필요한 사항의 규정을 목적으로 합니다.
...
부칙
제1조 (변경일) 이 약관은 2023년 4월 14일 변경한다.
제2조 (시행일) 이 약관은 2023년 4월 14일부터 시행한다.
(주)STANDSAFE
</body>
</html>