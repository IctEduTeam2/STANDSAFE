			...
			<article>
				...
				<form action="/admin_loginok.do" method="post">
					<div class="login-form">
						<input type="text" class="login-input-field" placeholder="ID" name="ID" required> 
							<input type="password"class="login-input-field" placeholder="Password" name="PW" required>
