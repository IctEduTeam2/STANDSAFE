...
<body onload="InitializeStaticMenu();">
	<div id="mydiv">
		...
		<section id="contents">
			<article>
						<div id="bbs_top" >					
					<div id="bbs_sub"><h1>내 게시글 보기</h1></div>
							<fieldset >
								<label>
					...
					<table class="m_table">				
						<thead class="mh_table">
							 <tr>
							 	<th id="th1">번호</th><th id="th4">파일첨부</th><th id="th2">제목</th><th id="th5">조회수</th><th id="th6">날짜</th>
							 </tr>
						</thead>
						<tbody class="mb_table">		
							<tr>
							<!-- 기본적으로 작성자로 검색하여 뽑아오기 -->
								<td>2</td><td>있음/없음표시</td><td><a href="/bbs_review_onelist.do">(예시 연결)해당 제목</a></td><td>해당 조회수</td><td>해당 날짜 내림차순</td>
							</tr>	
						</tbody>
					</table>
					</article>
