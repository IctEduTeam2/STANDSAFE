...
//삭제게시물 검색
function searchDeletedFaq() {
    $.ajax({
        url: '/adfaq_deleted.do',
        type: 'GET',
        success: function(response) {
            $("#bal").html(response);
        },
...
<body>
	...
	<div class="search_wrap">
		<div
			...
			<h1 style="text-align: center; font-size: 18px;">전체 이용안내 게시글 : ${totalFaq}개</h1>
			</p>
			<br>
			<h1 style="text-align: center; font-size: 18px;">등록한 이용안내 게시글 : ${registeredFaq}개</h1>
			</p>
			<br>
			<p>
			<h1 style="text-align: center; font-size: 18px;">삭제한 이용안내 게시글 : ${deletedFaq}개</h1>
			</p>
		</div>
