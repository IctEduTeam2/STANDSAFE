...
<jsp:include page="header.jsp"></jsp:include>
		...
		<h1 style="text-align: center; font-size: 18px;">전체 이용안내 게시글 : 125개</h1></p>
		<br>
		<h1 style="text-align: center; font-size: 18px;">등록한 이용안내 게시글: 125개</h1></p>
		<br>
	...
	<thead>
		...
		<div>
			<span style="float: right; margin-top: 25px; margin-right: 180px;">
				<button type="button" alt="이용안내FAQ" value="이용안내FAQ"
				style="width: 150px; height: 50px; font-size: 16px; border-radius: 10px; background-color: #505BBD; color: white; border: none;" onclick="location.href='/ad_allfaq.do'">이용안내FAQ❐</button>
			</span> <span style="float: right; margin-top: 25px; margin-right: 50px;">
				<button type="button" alt="글쓰기" value="글쓰기"
				style="width: 150px; height: 50px; font-size: 16px; border-radius: 10px; background-color: #505BBD; color: white; border: none;"onclick="location.href='/ad_faqform.do'">글쓰기</button>
			</span> <span style="float: right; margin-top: 25px; margin-right: 50px;">
