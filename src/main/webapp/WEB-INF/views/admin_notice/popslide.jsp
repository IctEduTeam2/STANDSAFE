...
<jsp:include page="header.jsp"></jsp:include>
		...
		<h1 style="text-align: center; font-size: 18px;">현재 오픈중인 팝업 : 111개</h1></p>
		<br>
		<h1 style="text-align: center; font-size: 18px;">현재 오픈중인 슬라이드 : 111개</h1></p>
		<br>
		<p><h1 style="text-align: center; font-size: 18px;">삭제한 게시글 : 7개</h1></p>
		</div>
