...
<jsp:include page="header.jsp"></jsp:include>
		...
		<h1 style="text-align: center; font-size: 18px;">전체 신고 게시글 : 125개</h1></p>
		<br>
		<h1 style="text-align: center; font-size: 18px;">등록한 신고 게시글 : 125개</h1></p>
		<br>
	...
	<thead>
		...
		<div>
			<span style="float: right; margin-top: 25px; margin-right: 180px;">
				<button type="button" alt="신고게시판" value="신고게시판"
				style="width: 150px; height: 50px; font-size: 16px; border-radius: 10px; background-color: #505BBD; color: white; border: none;" onclick="location.href='/ad_allreport.do'">신고게시판❐</button>
			</span>
		</div>
		<!-- 수평선 추가1 -->
