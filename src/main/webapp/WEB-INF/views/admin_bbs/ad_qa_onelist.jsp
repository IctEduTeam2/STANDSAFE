...
<script type="text/javascript">
	...
	function bbs_go_adqa_update(f) {
		location.href="/adqa_update.do";
...
<body onload="InitializeStaticMenu();">
	<div id="mydiv">
		...
		<section id="contents">
			<article>
					<hr class="hr">
					<div id="bbs_sub"><h1>상품Q&A 답글 상세화면</h1></div>
					...
					<!--db랑 연결시 name부분은 db와 동일하게.  -->
						<table class="m_table">
							...
							<tfoot>
								<tr align="center">
									<td colspan="2">
										<input type="button" value="수정" onclick="bbs_go_adqa_update(this.form)" class="in_btn"/>
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
