...
<script type="text/javascript">
	function save_go(f) {
		f.action="/admin_report_repleok.do";
		f.submit();
	}
	function list_go(f) {
...
<body>
	<div id="mydiv"> 
		...
		<section id="contents">
			<article>				
					<hr class="hr">
					<div id="bbs_sub"><h1>신고게시글 답글화면</h1>
						...
						<table class="m_table">
							<tr align="center">
								<td bgcolor="#1b5ac2" class="w_font">유형</td>
									<td id="radio">
										<input type="radio" name="REPORT_TYPE" value="답글" checked />
										<span>답글</span>	
									</td>
							</tr>
							...
							<tr align="center">
								...
								<td><input type="text" name="REPORT_WRITER" size="20" autocomplete='off' value="${admin_name}" disabled /></td>
							</tr>
							<tr align="center">
								<td bgcolor="#1b5ac2" class="w_font">제목</td>
								<td><input type="text" name="REPORT_SUBJECT" size="20" value="답글입니다." autocomplete='off' disabled /></td>
							</tr>
							...
							<tfoot>
								<tr align="center">
									<td colspan="2">
										...
										<input type="hidden" name="REPORT_SUBJECT" value="답글입니다.">
