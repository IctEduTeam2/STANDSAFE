				...
				<form method="post" enctype="multipart/form-data" id="form">
					...
					<table class="m_table">
						<tr align="center">
							...
							<td id="radio"><input type="radio" name="NOTICE_TYPE"
								value="공지사항" checked /> <span>공지사항</span></td>
						</tr>
						<tr align="center">
							<td bgcolor="#1b5ac2" class="w_font">작성자</td>
							<!--이건 로그인한 사람이 자동으로 뜨게하기.  -->
							<td><input type="text" name="NOTICE_WRITER" size="20"
								value="${mvo.NOTICE_WRITER}" autocomplete='off' disabled /></td>
						</tr>
						<tr align="center">
							<td bgcolor="#1b5ac2" class="w_font">제목</td>
							<td><input type="text" name="NOTICE_SUBJECT" size="20"
								value="${mvo.NOTICE_SUBJECT}" autocomplete='off' disabled /></td>
						</tr>
							...
							<c:choose>
								...
								<c:otherwise>
									<td><input type="file" name="file">이전
										파일명(${mvo.NOTICE_FILE})</td>
									<input type="hidden" name="old_f_name"
										value="${mvo.NOTICE_FILE}">
								</c:otherwise>
							</c:choose>
						</tr>
						<tr align="center">
							<td colspan="2" style="border-bottom: none;"><textarea
									rows="10" cols="60" name="NOTICE_CONTENT" id="content">
												${mvo.NOTICE_CONTENT}
						</textarea></td>
						</tr>
						<tfoot>
							<tr align="center">
								<td colspan="2"><input type="button" value="수정"
									onclick="UpdateOk_go(this.form)" class="in_btn" />
									<input type="hidden" name="NOTICE_NUM" value="${mvo.NOTICE_NUM}">
									<input type="hidden" name="cPage" value="${cPage}">
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="button" value="목록"
									onclick="list_go(this.form)" class="in_btn" />
