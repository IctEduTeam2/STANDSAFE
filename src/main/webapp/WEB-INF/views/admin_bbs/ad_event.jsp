...
<script type="text/javascript">
	...
	function bbs_go_adevent_writeform() {
		location.href="/ad_evewrite_go.do";
		
	}
	function return1(){
		location.href="/return1.do";
	...
	<div id="mydiv">
		...
		<section id="contents">
			<article>
					...
					<div>
					<button class="btn" onclick="bbs_go_adevent_writeform()">글쓰기</button>		
					<button class="btn" onclick="return1()">관리목록</button>		
					</div>		
					<hr class="hr">
					<!-- 메인 테이블 -->
					<table class="m_table">				
						...
						<tbody class="mb_table">		
							<tr>
								<td>2</td><td>있음</td><td><a href="/adevent_onelist.do">회원가입 이벤트 5000포인트 증정!</a></td><td>관리자</td><td>100</td><td>23.02.10</td>
							</tr>	
						</tbody>
					</table>
					</article>
