...
<script type="text/javascript">
	function save_go(f) {
		f.action="/admin_re_repleok.do";
		f.submit();
	}
	function list_go(f) {
		f.action="/admin_reivew.do";
		f.submit();
	}
						...
						<table class="m_table">
							<tr align="center">
								<td bgcolor="#1b5ac2" class="w_font">유형</td>
									<td id="radio">
										<input type="radio" name="RE_TYPE" value="답글" checked />
										<span>답글</span>	
									</td>
							</tr>
							...
							<tr align="center">
								...
								<td><input type="text" name="RE_WRITER" size="20" autocomplete='off' value="${admin_name}" disabled /></td>
							</tr>
							<tr align="center">
								<td bgcolor="#1b5ac2" class="w_font">제목</td>
								<td><input type="text" name="RE_SUBJECT" size="20" value="답글입니다." autocomplete='off' disabled /></td>
							</tr>
							...
							<tr align="center">
								<td colspan="2">
									<textarea rows="10" cols="60" name="RE_CONTENT" id="content"></textarea>
								</td>
							</tr>
							<tfoot>
								<tr align="center">
									<td colspan="2">
										...
										<input type="hidden" name="RE_SUBJECT" value="답글입니다.">
