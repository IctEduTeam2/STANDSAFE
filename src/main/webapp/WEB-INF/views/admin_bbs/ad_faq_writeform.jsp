						...
						<table class="m_table">
							<tr align="center">
								<td bgcolor="#1b5ac2" class="w_font">유형</td>
									<td id="radio">
										<input type="radio" name="FA_TYPE" value="결제/주문" checked />
										<span>결제/주문문의</span>	
										<input type="radio" name="FA_TYPE" value="배송" />
										<span>배송문의</span>	
										<input type="radio" name="FA_TYPE" value="기타" />
										<span>기타문의</span>	
									</td>
							</tr>
							...
							<tr align="center">
								...
								<td><input type="text" name="FA_SUBJECT" size="20" autocomplete='off' /></td>
							</tr>
							<tr align="center">
								<td colspan="2">
									<textarea rows="10" cols="60" name="FA_ANSWER" id="content"></textarea>
								</td>
							</tr>
							<tfoot>
								<tr align="center">
