	...
	<div id="mydiv">
		...
		<section id="contents">
			<article>
					...
					<button class="btn" onclick="return6()">관리목록</button>		
					</div>
					<hr class="hr">
					<!-- 메인 테이블 -->
					<table class="m_table">				
						...
						<tbody class="mb_table">		
							<tr>
								<td>2</td><td><img src="resources/images/bbs/fire.PNG" class="f_img"></td><td>상품 리뷰</td><td><a href="/adreview_onelist_user.do">소화기 강추합니다. 꼭 사세요!</a></td><td>일라오이</td><td>23.02.10</td>
							</tr>	
							<tr>
								<td>1</td><td><img src="" class="f_img"></td><td>상품 리뷰</td><td><a href="/adreview_onelist.do">[RE] 관리자 답글입니다. </a></td><td>관리자</td><td>22.01.10</td>
							</tr>	
