...
<body>
	<div id="mydiv">
		...
		<section>
			<article style="width: 80%;">
				<h1 style="text-align: center; font-size: 30px; margin-top: 10%;">상품등록 작성 화면</h1>
			</article> 
		</section>
		<div  style="width: 80%; height: 80%; float: left; margin-left: 10%; margin-top: 10px;">
		<form action="">
    ...
    <!-- 하단 버튼 -->
		<div style="margin-bottom: 20%; margin-left: 35%;">
			<span style="float: left; margin-top: 80px; margin-right: 100px;">
				<button type="button" value="작성">작성</button>
			</span> <span style="float: left; margin-top: 80px; margin-right: 100px;">
				<button type="button" value="다시" onclick="location.href='/product_insertform.do'">다시</button>
			</span> <span style="float: left; margin-top: 80px; margin-right: 100px;">
