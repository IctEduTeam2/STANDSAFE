...
<body>
		...
		<form id="searchForm" action="/admin/orderList" method="get">
			<table
				...
				<tr>
					...
					<td><select id="searchKey" name="searchKey" title="검색항목"
						class="select_option"
					...
					<td colspan="3"><input type="text" id="proNm" name="proName"
						value="" title="상품명검색" style="width: 300px; height: 40px;">
					</td>
				</tr>
				<tr>
					<th style="width: 200px;">주문 날짜</th>
					<td><input type="date" style="height: 40px; width: 300px;">
					</td>
					<td><input type="date" style="height: 40px; width: 300px;">
					</td>
				</tr>
	...
	<div class="admin_content_wrap" style="margin: auto; width: 100%;">
		<div style="width: 80%; margin: auto;">
			<div
				style="width: 98%; background-color: #1b5ac2; color: white; margin: 30px 0; padding-left: 2%; padding-top: 50px; padding-bottom: 50px; float: left; font-size: 32px;">반품
				목록</div>
		</div>
				...
				<tbody>
					<c:forEach items="${list}" var="rvo">
						<tr>
							...
							<td><a href="/return_detail.do?pb_num=${rvo.PB_NUM}">${rvo.PAY_NUM }</a></td>
							<td>${rvo.CLIENT_NUM }</td>
