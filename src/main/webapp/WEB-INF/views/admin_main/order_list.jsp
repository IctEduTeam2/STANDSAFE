				...
				<tbody>
					<c:forEach items="${list}" var="ovo">
						<tr>
							...
							<td><a href="/order_detail.do?pay_oknum=${ovo.PAY_OKNUM}">${ovo.PAY_OKNUM}</a></td>
						...
						<td colspan="7">
							<ol class="paging">
								...
								<c:choose>
									...
									<c:otherwise>
										<li><a href="/order_list.do?cPage=${paging.beginBlock-paging.pagePerBlock}&pageSize=10">이전으로</a></li>
									</c:otherwise>
								</c:choose>
								...
								<c:forEach begin="${paging.beginBlock}" end="${paging.endBlock}"
									...
									<c:if test="${k <= paging.totalPage}">
										...
										<c:if test="${k != paging.nowPage}">
											<li><a href="/order_list.do?cPage=${k}&pageSize=10">${k}</a></li>
										</c:if>
									</c:if>
								</c:forEach>
								...
								<c:choose>
									...
									<c:otherwise>
										<li><a href="/order_list.do?cPage=${paging.beginBlock+paging.pagePerBlock}&pageSize=10">다음으로</a></li>
									</c:otherwise>
								</c:choose>
							</ol>
						</td>
