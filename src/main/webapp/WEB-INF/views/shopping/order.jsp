    ...
    <div id="mydiv">
        ...
        <section id="contents">
            ...
            <div style="con">
                ...
                <table style="width: 100%; border: 1px solid black; border-spacing: 0px; border-collapse: collapse; font-weight: 700;">
                    <thead class="order_list_th">
                        <tr>
                            <th style="width: 5%;"><input type="checkbox" name="select" value="selectall" onclick="selectAll(this)"></th>
                    ...
                    <tbody class="order_list_td">
                        <tr>
                            ...
                            <td><img src="../images/error_message.png" style="width: 120px; height: 160px"></td>
                            <td><a href="#" style="font-size: 16px;">에러 메세지입니다 아아아아아sdfsfsdfsdf아아아아sdfasdasdasd아아아아아</a></td>
                            <td>26,000 원</td>
                            <td>2</td>
                            <td>52,000 원</td>
                        </tr>
                ...
                <table style="width: 100%; border-spacing: 0px; border-collapse: collapse; font-weight: 700;" class="user_data">
                    <tr>
                        <td>주문하시는분 <b style="color: red">*</b></td>
                        <td><input type="text" style="width: 400px; padding: 10px;"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" style="width: 100px; padding: 10px;"> - <input type="text" style="width: 100px; padding: 10px;"> - <input type="text" style="width: 100px; padding: 10px;"></td>
                    </tr>
                    <tr>
                        <td>이메일 <b style="color: red">*</b></td>
                        <td><input type="text" placeholder="example" style="width: 200px; padding: 10px;"> @ <input type="text" placeholder="email.com" style="width: 200px; padding: 10px;"></td>
                    </tr>
                    <tr>
                        <td>쇼핑몰 이용약관 <b style="color: red">*</b></td>
                        <td><textarea readonly style="resize: none; padding: 10px; font-size: 16px; width: 98.5%; height: 400px;">제1조(목적)
...
② "쇼핑몰"과 이용자간에 제기된 전자거래 소송에는 한국법을 적용합니다.</textarea>
                   <div style="float: right;"><input type="radio" name="terms" value="동의"><b> 동의함</b> <input type="radio" name="terms" value="비동의" style="margin-left: 30px; margin-top: 10px;" checked> <b>동의하지 않음</b></div></td>
                ...
                <table style="width: 100%; border-spacing: 0px; border-collapse: collapse; font-weight: 700;" class="user_data">
                    <tr>
                        <td>배송지 선택</td>
                        <td><input type="radio" name="delivery"> 주문자 정보와 동일 <input type="radio" checked style="margin-left: 50px;" name="delivery"> 새로운 배송지</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><textarea maxlength="200" style="resize: none; padding: 10px; font-size: 16px; width: 400px; height: 100px;"></textarea></td>
                    </tr>
                </table>

                <h3 style="margin-bottom: 20px; margin-top: 80px;">결제 수단</h3>

                <table style="width: 100%; border-spacing: 0px; border-collapse: collapse" class="user_data">
                    <tr>
                        <td style="width: 80%;"><input type="radio" checked name="payment"> 카드 결제 <input type="radio" style="margin-left: 50px;" name="payment"> 포인트 결제</td>
                        <td style="text-align: right;
	background-color: rgba(27, 90, 194, 1); color: white; font-size: 20px; font-weight: 700;">총 결제금액</td>
                    </tr>
                    <tr>
                        <td style="height: 300px;">
                            <div style="margin-top: 200px; color: gray; font-size: 20px;"><p style="margin-bottom: 20px;"><img src="resources/images/context.PNG" style="width: 30px; height: 30px;"> 최소 결제 가능 금액은 결제금액에서 배송비를 제외한 금액입니다.</p>
                            <p><img src="resources/images/context.PNG" style="width: 30px; height: 30px;">  소액 결제의 경우 PG 사 정책에 따라 결제 금액 제한이 있을 수 있습니다.</p>
                            </div>
                        </td>
                        <td style="text-align: right; background-color: rgba(27, 90, 194, 1); color: white; "><div style="margin-top: 150px;">
                            <div style="font-size: 30px; font-weight: 700; margin-bottom: 40px;">56,000 원</div>
                            <input type="submit" value="결제하기" style="font-size: 26px; width: 100%; height: 100px; border-radius: 20px" class="pay"></div>
                        </td>
                    </tr>
                </table>
            </div>
