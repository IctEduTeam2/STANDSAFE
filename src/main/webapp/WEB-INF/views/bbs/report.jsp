									...
									<td colspan="6">
										<ol class="paging">
											...
											<c:choose>
												...
												<c:otherwise>
													<li><a href="/bbs_report_go.do?cPage=${paging.beginBlock-paging.pagePerBlock }">이전으로</a></li>
												</c:otherwise>
											</c:choose>	
											...
											<c:choose>
												...
												<c:otherwise>
													<li><a href="/bbs_report_go.do?cPage=${paging.beginBlock+paging.pagePerBlock }">다음으로</a></li>
												</c:otherwise>
											</c:choose>					
										</ol>
									</td>
